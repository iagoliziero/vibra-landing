      ...
      <div className=" flex gap-8 max-w-[80%] ">
        <div className="text-center relative flex flex-col items-center justify-center  ">
          <div className="mt-6 xxl:mt8 flex flex-col items-center justify-center max-w-4xl md:max-w-2xl">
            ...
            <img
              src="/imgAna.png"
              alt="Imagem Ana Luyza"
              className="rounded-full w-60 h-auto bg-whiteBG mt-6 lg:hidden"
            />
          </div>
          <span className="mt-6">
            {" "}
            <ParagraphDarker>
              ...
              <br /> estudante de nutrição e uma menina como você: cheia de
              sonhos, mas que já se viu perdida no meio do caminho.
            </ParagraphDarker>{" "}
          </span>
          <br />
          <span>
            {" "}
            <ParagraphDarker>
              A Comunidade Vibra nasceu do meu próprio processo - de quando eu
              precisei reconstruir minha rotina, me entender e aprender a fazer
              as pazes com o tempo, com meu corpo e com a minha mente.
            </ParagraphDarker>{" "}
          </span>
        ...
        <div className="hidden lg:block relative top-20">
          <img
            src="./imgAna.png"
            alt="Imagem Ana Luyza"
            className="h-[20rem] rounded-full w-[25rem] bg-whiteBG "
          />
        </div>
      </div>
    </div>
